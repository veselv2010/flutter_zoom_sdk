...
public:
	 ...
	 * @note Use the handler to configure the related information. For more details, see \link IProxySettingHandler \endlink. 
	 ...
	 * @note Use the handler to check the related information. For more details, see \link ISSLCertVerificationHandler \endlink.
	 * The handler will be destroyed once the function calls end.
	 */
