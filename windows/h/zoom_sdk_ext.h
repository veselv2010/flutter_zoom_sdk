...
extern "C"
{
	 ...
	 * @return If the function succeeds, the return value is SDKErr_Success, and ppEmbeddedBrowser is not nullptr Otherwise failed. To get extended error information, see \link SDKError \endlink enum.
	 */
	 ...
	 * @return If the function succeeds, the return value is SDKErr_Success, and ppCustomiezedResourceHelper is not nullptr Otherwise failed. To get extended error information, see \link SDKError \endlink enum.
	 */
