...
public:
	 ...
	 * @note When the remote control or the authority changes, the user will receive a callback event.
	 */
	 ...
	 * @note For custom style mode, this interface is only valid after subscribing the sharing content from the specified user by calling ICustomizedShareRender::SetUserID(unsigned int userid) successfully.
	 * @return If it is able to request to control the specified user by long-distance, the return value is SDKERR_SUCCESS. Otherwise failed. To get extended error information, see \link SDKError \endlink enum.
	 */
	 ...
	 * @param shareSourceID Specify the share scource ID to check.
	 * @return If it is able to control the specified user by long-distance, the return value is SDKERR_SUCCESS. Otherwise failed. To get extended error information, see \link SDKError \endlink enum.
	 */
	 ...
	 * @param shareSourceID Specify the share scource ID to check.
	 * @return If the specified user is in process of remote control, the return value is SDKERR_SUCCESS. Otherwise failed. To get extended error information, see \link SDKError \endlink enum.
	 */
