...
public:
	 ...
	 * @return If the function succeeds, the return value is the sign interpretation status of current meeting.  Otherwise failed. For more details, see \link SignInterpretationStatus \endlink enum.
	 */
	 ...
	 * @return If it can start the sign interpretation, the return value is SDKErr_Success. Otherwise failed. To get extended error information, see \link SDKError \endlink enum.
	 */
