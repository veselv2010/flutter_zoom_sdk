...
public:
	 ...
	 * @note If it is true, the SDK will trigger the IMeetingConfigurationEvent::onWebinarNeedRegisterNotification()callback event. For more details, see \link IMeetingConfigurationEvent::onWebinarNeedRegisterNotification() \endlink.
	 */
	 ...
	 * @param bRedirect TRUE indicates to redirect. FALSE not. 
	 * @note If it is true, the SDK will trigger the IMeetingConfigurationEvent::onWebinarNeedInputScreenName()callback event. For more details, see \link IMeetingConfigurationEvent::onWebinarNeedInputScreenName() \endlink.
	 */
	 ...
	 * @param bRedirect TRUE indicates to redirect. FALSE not. 
	 * @note If it is true, the SDK will trigger the IMeetingConfigurationEvent::onJoinMeetingNeedUserInfo()callback event. For more details, see \link IMeetingConfigurationEvent::onJoinMeetingNeedUserInfo() \endlink.
	 */
	 ...
	 * @param bRedirect TRUE indicates to redirect. FALSE not. 
	 * @note If it is true, the SDK will trigger the IMeetingConfigurationEvent::onUserConfirmToStartArchive()callback event. For more details, see \link IMeetingConfigurationEvent::onUserConfirmToStartArchive() \endlink.
	 */
	 ...
	 * @param bRedirect TRUE indicates to redirect. FALSE not. 
	 * @note If it is true, the SDK will trigger the IMeetingConfigurationEvent::onUserConfirmRecoverMeeting()callback event. For more details, see \link IMeetingConfigurationEvent::onUserConfirmRecoverMeeting() \endlink.
	 */
	 ...
	 * For more details, see \link  IMeetingConfigurationEvent::onEndOtherMeetingToJoinMeetingNotification() \endlink.
	 */
	 ...
	 * For more details, see \link IMeetingConfigurationEvent::onInputMeetingPasswordAndScreenNameNotification() \endlink.
	 */
