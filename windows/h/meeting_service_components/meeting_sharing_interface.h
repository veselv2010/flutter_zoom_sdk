...
typedef struct tagZoomSDKSharingSourceInfo
{
	...
	/** The values of sharing status, see \link SharingStatus \endlink enum. */
	...
	/** Type of sharing, see \link ShareType \endlink enum. */
...
public:
	 ...
	 * @return If it is supported, the return value is SDKERR_SUCCESS. Otherwise not. To get extended error information, see \link SDKError \endlink enum.
	 * @note Valid for both ZOOM style and user custom interface mode.
	 */
	 ...
	 * @return True indicates that the user can share to the breakout room. Otherwise the function fails. To get extended error information, see \link SDKError \endlink enum.
	 * @note Valid for user custom interface mode only.	
	 */
	 ...
	 * @return If the function succeeds, the return value is SDKERR_SUCCESS. Otherwise the function fails and returns error. To get extended error information, see \link SDKError \endlink enum.
	 */
