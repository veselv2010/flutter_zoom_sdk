...
enum VideoRenderElementType
{
	...
	/** Preview type, see \link IPreviewVideoRenderElement \endlink. */
	VideoRenderElement_PRVIEW,
	/** Active type, see \link IActiveVideoRenderElement \endlink. */
	VideoRenderElement_ACTIVE,
	/** Normal type, see \link INormalVideoRenderElement \endlink. */
...
public:
	 ...
	 * @note Call Subscribe with the other ID if you want to view his data.
...
public:
	 ...
	 * @note The specified video render element will be destroyed once the function calls end. The user should complete the operations to the related video render element.
	 */
...
public:
	 ...
	 * @return If the function succeeds, the return value is SDKErr_Success, the return value of ppElement is not nullptr. Otherwise failed. To get extended error information, see \link SDKError \endlink enum.
	 */
	 ...
	 * @return If the function succeeds, the return value is the list that stores the video render element. Otherwise failed, the return list is blank.
	 */
