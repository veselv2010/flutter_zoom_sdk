...
public:
	 ...
	 * @return If the function succeeds, the return value is SDKErr_Success, and ppMeetingService is not nullptr. Otherwise failed. To get extended error information, see \link SDKError \endlink enum.
