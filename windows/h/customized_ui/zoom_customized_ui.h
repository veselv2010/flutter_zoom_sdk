...
extern "C"
{
	 ...
	 * @return If the function succeeds, the return value is SDKErr_Success, while the return value of ppCustomizedUIMgr is not nullptr. Otherwise failed. To get extended error information, see \link SDKError \endlink enum.
	 */
