...
{
	/** User type. For more details, see \link SDKUserType \endlink enum. */
...
public:
	...
	* @return IList<GrantCoOwnerAssetsInfo>* A pointer to a newly created list of GrantCoOwnerAssetsInfo.For more details, see \link GrantCoOwnerAssetsInfo \endlink.
	...
	* @param list A pointer to the list to be destroyed.For more details, see \link GrantCoOwnerAssetsInfo \endlink.
...
public:
	 ...
	 * @return If the function succeeds, the return value is the current meeting status.  Otherwise failed. To get extended error information, see \link MeetingStatus \endlink enum.
	 */
	virtual MeetingStatus GetMeetingStatus() = 0;
	
	/**
	 * @brief Lock the current meeting.
	 * @return If the function succeeds, the return value is the SDKErr_Success. Otherwise failed. To get extended error information, see \link SDKError \endlink enum.
	 */
	 ...
	 * @param sTopic The new meeting topic. 
	 * @return If the function succeeds, the return value is the SDKERR_SUCCESS. Otherwise fails. To get extended error information, see \link SDKError \endlink enum.
	 */
